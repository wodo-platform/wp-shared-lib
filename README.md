...
<div align="center">
<h2> Wodo Platform Shared Library </h2>
</div>
...
This module contains shared constants, definitions and entities that do not change often and are used by other wodo gaming modules and services. Some examples would be gamer types, game types
...
Please follow the steps below to publish wg-shared-lib npm package from your local development environment.
...
Verif that wg-shared-lib package has been published successfully with the correct version you provided in package.json file. Go to the page below and make sure that your packge is listed on the  published artifact list
...
```
"dependencies": {
        "@wodo-platform/wg-shared-lib": "1.0.0",
